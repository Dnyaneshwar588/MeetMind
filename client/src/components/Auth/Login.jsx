...
export const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to meeting room or dashboard
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Welcome to MeetMind</h2>
          <p className="text-slate-500 text-xs mt-1.5 text-center">Sign in to join collaborative AI-powered rooms</p>
        </div>
